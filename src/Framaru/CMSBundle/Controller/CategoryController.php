...
use Framaru\CMSBundle\Entity\Category;
...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('@CMS/category/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Framaru\CMSBundle\Form\CategoryType', $category);
        ...
        return $this->render('@CMS/category/new.html.twig', array(
            'category' => $category,
    ...
    public function showAction(Category $category)
    {
        ...
        return $this->render('@CMS/category/show.html.twig', array(
            'category' => $category,
    ...
    {
        $deleteForm = $this->createDeleteForm($category);
        $editForm = $this->createForm('Framaru\CMSBundle\Form\CategoryType', $category);
        ...
        return $this->render('@CMS/category/edit.html.twig', array(
            'category' => $category,
