...
use Framaru\CMSBundle\Entity\User;
...
class UserController extends Controller
{
    ...
    {
        $user = new User();
        $form = $this->createForm('Framaru\CMSBundle\Form\UserType', $user);
    ...
    {
        $deleteForm = $this->createDeleteForm($user);
        $editForm = $this->createForm('Framaru\CMSBundle\Form\UserType', $user);
